...
<div class="page-wrapper clients" style="background-color: white;">
  <div class="row" style="margin-right: 0;">
      <div class="col-6">
        <div class="clients-left" style="vertical-align: middle;">
      ...
      <div class="col-6">
        <!-- <h3 class="clients-right"><strong class="orange-text">Get to know<br> some of our clients</strong></h3> -->
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active carousel-logo" style="vertical-align: middle;">
                  <h3><strong class="orange-text">Get to know<br> some of our clients</strong></h3>
                  <img src="/media/citizen_shipper.svg" class="d-block w-50 center" style="margin-top:10vh; margin-bottom: 10vh" alt="...">
                  <div class="carousel-caption d-none d-md-block" style="position: revert; padding-left: 5vw;">
                      <h5>Citizen Shipper (USA)</h5>
                  </div>
                </div>
                <div class="carousel-item" style="vertical-align: middle;">
                  <img src="/media/citizen_shipper.svg" class="d-block w-50" style="margin-top:10vh; margin-bottom: 10vh" alt="...">
                  ...
                  <p>Richard Obousy, <br>CEO, CitizenShipper (USA)</p>
                </div>
              </div>
          ...
          <ol class="carousel-indicators clients-right" style="position: revert;">
